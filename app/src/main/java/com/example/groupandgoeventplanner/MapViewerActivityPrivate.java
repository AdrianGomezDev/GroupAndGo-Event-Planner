...
public class MapViewerActivityPrivate extends FragmentActivity implements OnMapReadyCallback {
    ...
    public static MapViewerActivityPrivate newInstance() {
        MapViewerActivityPrivate fragment = new MapViewerActivityPrivate();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        DocumentReference docRef = ref.collection("users")
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    if (document.exists()) {
                        ...
                        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(latLngHome,zoom));
                    } else {
